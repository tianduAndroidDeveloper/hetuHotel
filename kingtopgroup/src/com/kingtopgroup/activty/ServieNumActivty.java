...
public class ServieNumActivty extends FragmentActivity implements OnClickListener{
	private CycleViewPager cycleViewPager;
	private RadioButton service_content,service_scope,you_must_know;
	private TextView service_num_webview,product_item_name,product_item_price,product_item_time,product_item_begin_num,product_item_need;
	...
	private Button service_add_button,service_reduce_button,service_num_button,service_num_next_button;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		//==========================================进度条=============================================
		service_progressbar=(ProgressBar) findViewById(R.id.service_progressbar);
	...
	private void ObjectToListmap(JSONObject obj){
	   ...
	   int index=price.indexOf(".");
		...
		case R.id.service_num_next_button://点击下一步
			...
			//String  parans="?Uid="+Uid+"&Pid="+pid+"&BuyCount="+BuyCount+"&StoreRId="+StoreRId+"&couponid="+couponid+"&ItemIdList="+ItemIdList;
			RequestParams params = null;
			params=new RequestParams();
			String  parans="{\"Pid\":"+pid+",\"Uid\":"+Uid+",\"BuyCount\":"+BuyCount+",\"StoreRId\":"+StoreRId+",\"couponid\":"+couponid+",\"ItemIdList\":"+ItemIdList+"}";
				...
				public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
					if(arg0==200){
						try {
							...
							String ReturnValue=obj.getString("ReturnValue");
							if(ReturnValue.equals("0")){
								//ToastUtils.show(this, "亲，服务器忙，请稍后重试");
							}else{
								//保存订单号
								UserBean.getUSerBean().setOpid(ReturnValue);
							}
						} catch (JSONException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
