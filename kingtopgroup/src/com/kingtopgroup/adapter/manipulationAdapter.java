...
public class manipulationAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.order_item_time.setText((CharSequence) ItemInfoList.get(position).get("time") + "·ÖÖÓ");
		...
		if (attrvalue != null)
			holder.iv_attrvalue.setImageResource(attrvalue.contains("×ø") ? R.drawable.zuob : R.drawable.tang_yuan);
